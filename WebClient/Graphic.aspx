<%@ Page Language="C#" MasterPageFile="~/TreeTemplate.master" AutoEventWireup="true" CodeBehind="Graphic.aspx.cs" Inherits="WebClient.Graphic" Theme="GlobalSkin" Culture="auto" UICulture="auto"%>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<%@ Register Assembly="ZedGraph.Web" Namespace="ZedGraph.Web" TagPrefix="zgw" %>

<%@ Register src="GraphUserControl.ascx" tagname="GraphUserControl" tagprefix="uc1" %>
...
--%>
    ...
    <uc1:GraphUserControl ID="GraphUserControl1" runat="server" />
